...
public class Solution
{
    ...
    static abstract class Dog implements Moveable, Eat
    {
    }

    static abstract class Cat implements Moveable, Eatable, Eat
    {
    }

    static abstract class Mouse implements Moveable, Eatable
    {
    }
}
